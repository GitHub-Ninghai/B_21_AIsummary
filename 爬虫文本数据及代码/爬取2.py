...
# 目标网址
base_url = 'https://search.usa.gov/search?query=B-21&affiliate=dodlive_amnmag&utf8=%26%23x2713%3B'
...
if response.status_code == 200:
    ...
    h3_tags = soup.find_all('h4', class_='title')
