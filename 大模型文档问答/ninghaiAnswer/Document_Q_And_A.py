...
class Document_Q_And_A:
    ...
    def get_body(self,user_content):
        data = {
            "chatExtends": {
...
def main(user_question):
    ...
    body = document_Q_And_A.get_body(user_question)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Document Q&A with XFyun')
    parser.add_argument('--user_question', type=str, required=True, help='The user question for the Q&A system')
    args = parser.parse_args()
    main(args.user_question)
